...
pub trait DisplayBaid64<const LEN: usize = 32> {
    ...
    fn to_baid64_string(&self) -> String {
        self.display_baid64().to_string()
    }
    fn to_baid64_mnemonic(&self) -> String {
        self.display_baid64().mnemonic
    }
...
mod tests {
    ...
    /// Test the `Display` implementation of `Baid64Display` for correct formatting.
    #[test]
    ...
    /// Test the `from_baid64_str` method for accurate parsing and error handling.
    #[test]
